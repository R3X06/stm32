...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : MDP-G15 BLINK TEST - firmware-alive check only.
  *   Does nothing but blink the onboard LED (PE10) and beep the buzzer (PB10).
  *   If the LED blinks / buzzer ticks, the chip flashes & runs your code.
  *   This is a TEMPORARY diagnostic - restore your real main.c afterwards.
  ******************************************************************************
  */
...
int main(void)
{
  ...
  /* Blink LED (PE10) + tick buzzer (PB10) forever. */
  while (1)
  {
      HAL_GPIO_TogglePin(GPIOE, GPIO_PIN_10);   /* LED */
      HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_10);   /* Buzzer - audible tick */
      HAL_Delay(300);
  }
}
